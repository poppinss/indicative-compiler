[indicative-compiler](../README.md) > ["test-helpers/ErrorFormatter"](../modules/_test_helpers_errorformatter_.md) > [ErrorFormatter](../classes/_test_helpers_errorformatter_.errorformatter.md)
